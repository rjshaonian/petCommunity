...
public class SpringShiroConfig {
	...
	/**
	 * 配置ShiroFilterFactoryBean对象，通过此对象 创建过滤器工厂，并指定过滤规则
	 * 
...
//		map.put("/**", "user");// 记住我时将authc改为user
	...
	// ===========授权配置============
	/**
	 * spring 框架管理此对象时,会基于此对象管理 Shiro框架中相关API对象的生命周期
	 */
	@Bean // <bean id="" class="">
	...
	/**
	 * 配置此对象的目的是,在spring容器启动时, 扫描所有的advisor(顾问)对象,基于advisor 对象中切入点的描述,为目标对象创建代理对象
	 */
...
//	}
	/**
	 * 配置Advisor对象,此对象中会对切入点,通知等对象进行 相关描述,后续DefaultAdvisorAutoProxyCreator对象
	 * 会基于描述,为目标对象创建代理对象
	 * 
	 * @param securityManager
	 * @return
