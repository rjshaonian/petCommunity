...
public class RocketmqProducerInit {
	...
	/*
	 * 
	 * //当无法注入实例的时候可以使用此方法进行实例初始化 private static class ProducerHolder { private
	 * static final RocketmqProducerInit INSTANCE = new RocketmqProducerInit(); }
	 * 
	 * private RocketmqProducerInit (){
	 * 
	 * }
	 * 
	 * public static final RocketmqProducerInit getInstance() { return
	 * ProducerHolder.INSTANCE; }
	 */
